...
def generate_review_pack() -> dict:
    ...
    review_summary = {
        ...
        "nextImprovement": "Automate the experimental browser review capture flow end-to-end so the shared manager evidence can be refreshed without a manual Playwright screenshot step.",
        "verifiedAt": DATE_TAG,
    }
    ...
    markdown_lines.extend(
        [
            ...
            "## What failed",
            "",
            "- The desktop capture flow does not itself generate the browser prototype screenshots.",
            "",
            "## Workaround",
            "",
